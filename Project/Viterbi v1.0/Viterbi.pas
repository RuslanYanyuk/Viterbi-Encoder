...
Label2.Caption := 'Соощение в двоичном коде ('+IntToStr(length(RichEdit2.Text))+' бит)';
end;
...
RichEdit3.Text := res;
Label3.Caption := 'Закодированное сообщение ('+IntToStr(length(RichEdit3.Text))+' бит)';
end;
...
RichEdit4.Text := str;
Label6.Caption := 'После прохождения канала ('+IntToStr(length(RichEdit4.Text))+' бит)';
