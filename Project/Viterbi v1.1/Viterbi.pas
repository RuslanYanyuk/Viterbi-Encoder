...
Label2.Caption := 'Повідомлення в двійковому коді ('+IntToStr(length(RichEdit2.Text))+' біт)';
end;
...
RichEdit3.Text := res;
Label3.Caption := 'Закодоване повідомлення ('+IntToStr(length(RichEdit3.Text))+' біт)';
end;
...
errorProbability:= trunc(SpinEdit2.Value * 100);
// очищаем стили
...
RichEdit4.Text := str;
Label6.Caption := 'Після проходження каналу ('+IntToStr(length(RichEdit4.Text))+' біт)';
